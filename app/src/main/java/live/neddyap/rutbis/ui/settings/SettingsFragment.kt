...
import live.neddyap.rutbis.databinding.ItemSettingsBinding
class SettingsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val accountItemBinding = ItemSettingsBinding.bind(root.findViewById(R.id.account_item))
        ...
        val appSettingsItemBinding =
            ItemSettingsBinding.bind(root.findViewById(R.id.app_settings_item))
        ...
        val aboutItemBinding = ItemSettingsBinding.bind(root.findViewById(R.id.about_item))
        ...
        val supportItemBinding = ItemSettingsBinding.bind(root.findViewById(R.id.support_item))
        ...
        val logoutItemBinding = ItemSettingsBinding.bind(root.findViewById(R.id.logout_item))
